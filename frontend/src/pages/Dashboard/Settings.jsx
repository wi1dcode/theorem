  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        <button
          type="submit"
          className="tracking-wide mt-4 rounded-lg bg-vert_principal px-4 py-2 text-center text-base font-semibold text-white shadow-md transition ease-in hover:bg-vert_principal/80"
        >
