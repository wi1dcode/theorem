      ...
      <div>
        <div>
          <div className="relative px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-12">
            <div className="absolute inset-x-0 top-0 items-center justify-center hidden overflow-hidden md:flex md:inset-y-0 h-[89vh]">
              <svg
                viewBox="0 0 88 88"
                className="w-full max-w-screen-xl text-marron/20"
              >
            ...
            <div className="relative grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
              <div className="flex flex-col justify-between overflow-hidden text-left transition-shadow duration-200 bg-white rounded shadow-xl group hover:shadow-2xl">
                <div className="p-5">
                  ...
                  <p className="mb-2 font-bold">Conduite de travaux</p>
                  <p className="text-sm leading-5 text-gray-900">
                    Un interlocuteur unique pour vos travaux clé en main (neuf
                    et réhabilitation).
                  </p>
                </div>
              ...
              <div className="flex flex-col justify-between overflow-hidden text-left transition-shadow duration-200 bg-white rounded shadow-xl group hover:shadow-2xl">
                <div className="p-5">
                  ...
                  <p className="mb-2 font-bold">Bureau d'etudes</p>
                  <p className="text-sm leading-5 text-gray-900">
                    Space planning afin d’optimiser les espaces et les flux
                    inter-services. Analyse de faisabilité technique et
              ...
              <div className="flex flex-col justify-between overflow-hidden text-left transition-shadow duration-200 bg-white rounded shadow-xl group hover:shadow-2xl">
                <div className="p-5">
                  ...
                  <p className="mb-2 font-bold">Conseils</p>
                  <p className="text-sm leading-5 text-gray-900">
                    Fort de 28 ans d’expériences, nous pouvons être force de
                    proposition sur vos projets : imitation des coûts, pérennité
                    des matériaux mis en œuvre, synthèse des lots, …
                  </p>
                </div>
                <div className="w-full h-1 ml-auto duration-300 origin-left transform scale-x-0 bg-white group-hover:scale-x-100" />
              </div>
              <div className="flex flex-col justify-between overflow-hidden text-left transition-shadow duration-200 bg-white rounded shadow-xl group hover:shadow-2xl">
                <div className="p-5">
                  ...
                  <p className="mb-2 font-bold">Accompagnement</p>
                  <p className="text-sm leading-5 text-gray-900">
                    Mairie, instances représentatives du personnel, organisme de
                    contrôle, etc.
                  </p>
                </div>
                <div className="w-full h-1 ml-auto duration-300 origin-left transform scale-x-0 bg-white group-hover:scale-x-100" />
