...
export default function ProMenu({ onClick }) {
  return (
    <nav className="flex-1 -mx-3 space-y-3 avenir">
      ...
      >
        ...
        <span className="mx-2 text-sm font-semibold">Mon information</span>
      </Link>
      <Link
        className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg  hover:bg-gray-100 hover:text-gray-700"
        to="./rdv"
      ...
      >
        ...
        <span className="mx-2 text-sm font-semibold">Important</span>
      </Link>
      <Link
        className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg  hover:bg-gray-100 hover:text-gray-700"
        to="./settings"
